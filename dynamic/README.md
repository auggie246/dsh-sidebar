...
These files are the **dynamic Cordis plugin** form of dsh-sidebar: the
...
- `dsh-sidebar.dynamic.json` — generated single-file bundle
...
> Read `dynamic/dsh-sidebar.dynamic.json`. Call `cordis_define` with a new
