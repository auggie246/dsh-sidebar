...
// seam(#7): add the readFile result codec directly above this line
// seam(#8): add the pty result codecs directly above this line
...
// seam(#7): add param codecs directly above this line
// seam(#8): add param codecs directly above this line
...
export const TYPERT = Object.freeze({
  ...
  invocations: [
    ...
    // seam(#8): add the ptyResize invocation directly above this line
  ],
...
const METHODS = [
  ...
  // seam(#8): add 'ptyResize' directly above this line
]
...
export class GitSidebarGateway extends TypertRemoteService {
  ...
  // seam(#7): add the readFile gateway method directly above this line
  // seam(#8): add the ptyResize gateway method directly above this line
}
